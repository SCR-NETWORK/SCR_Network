...
// Params defines a SCR network by its parameters. These parameters may be
// used by SCR applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/SCR-NETWORK/research/issues/3
...
// MainnetParams defines the network parameters for the main SCR network.
...
// TestnetParams defines the network parameters for the test SCR network.
var TestnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSCRTest,
...
// SimnetParams defines the network parameters for the simulation test SCR
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSCRSim,
...
// DevnetParams defines the network parameters for the development SCR network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSCR-NETWORKev,
	Prefix: util.Bech32PrefixSCR_Networkev,
...
// ErrDuplicateNet describes an error where the parameters for a SCR
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate SCR network")

var registeredNets = make(map[appmessage.SCR-NETWORKNet]struct{})

// Register registers the network parameters for a SCR network. This may
