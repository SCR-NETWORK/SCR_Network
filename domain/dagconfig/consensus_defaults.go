...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.LeorPerSCR
	defaultPreDeflationaryPhaseBaseSubsidy         = 150 * constants.LeorPerSCR
	defaultDeflationaryPhaseBaseSubsidy            = 140 * constants.LeorPerSCR
