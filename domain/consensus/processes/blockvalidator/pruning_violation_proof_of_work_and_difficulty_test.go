...
import (
	...
	"github.com/SCR-NETWORK/SCR_Network/domain/consensus/utils/blockheader"
	...
	"github.com/SCR-NETWORK/SCR_Network/domain/consensus/utils/merkle"
...
func TestPOW(t *testing.T) {
	...
	testutils.ForAllNets(t, false, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		if consensusConfig.Name != "SCR-mainnet" {
		if consensusConfig.Name != "SCR-mainnet" {
