...
import (
	...
	"github.com/SCR-NETWORK/SCR_Network/domain/consensus/utils/multiset"
	"github.com/SCR-NETWORK/SCR_Network/domain/consensus/utils/utxo"
	"github.com/SCR-NETWORK/SCR_Network/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that SCR-NETWORK doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
// This is a sanity test, to make sure that SCR_Network doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
