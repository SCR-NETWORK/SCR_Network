...
// SignatureScript creates an input signature script for tx to spend SCR sent
// SignatureScript creates an input signature script for tx to spend SCR sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend SCR sent
// SignatureScriptECDSA creates an input signature script for tx to spend SCR sent
