/*
Package txscript implements the SCR transaction script language.

This package provides data structures and functions to parse and execute
SCR transaction scripts.
Package txscript implements the SCR transaction script language.
...
SCR transaction scripts are written in a stack-base, FORTH-like language.

The SCR script language consists of a number of opcodes which fall into
The SCR script language consists of a number of opcodes which fall into
...
Typical SCR scripts at the time of this writing are of several standard
Typical SCR scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend SCR.
what conditions must be met in order to spend SCR.
