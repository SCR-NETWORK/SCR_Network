...
import (
	...
	"github.com/SCR-NETWORK/SCR_Network/domain/consensus/utils/serialization"

	"github.com/SCR-NETWORK/SCR_Network/domain/consensus/model/externalapi"
	"github.com/SCR-NETWORK/SCR_Network/domain/consensus/utils/hashes"
	"github.com/SCR-NETWORK/SCR_Network/domain/consensus/utils/transactionhelper"
	"github.com/SCR-NETWORK/SCR_Network/util/binaryserializer"
...
// writeTransactionInput encodes ti to the SCR protocol encoding for a transaction
// writeTransactionInput encodes ti to the SCR protocol encoding for a transaction
// input to w.
