...
import (
	...
	"github.com/SCR-NETWORK/SCR_Network/cmd/SCRwallet/libSCRwallet"
	"github.com/SCR-NETWORK/SCR_Network/domain/consensusreference"
	"github.com/SCR-NETWORK/SCR_Network/domain/miningmanager/model"
	...
	"github.com/SCR-NETWORK/SCR_Network/domain/consensus/utils/transactionhelper"
	...
	"github.com/SCR-NETWORK/SCR_Network/domain/miningmanager"
...
func generateNewCoinbase(addressPrefix util.Bech32Prefix, op opType) (*externalapi.DomainCoinbaseData, error) {
	...
	_, publicKey, err := libSCRwallet.CreateKeyPair(op == opECDSA)
	_, publicKey, err := libSCRwallet.CreateKeyPair(op == opECDSA)
	if err != nil {
		return nil, err
	}
