...
import (
	...
	"github.com/SCR-NETWORK/SCR_Network/domain/miningmanager/blocktemplatebuilder"
	mempoolpkg "github.com/SCR-NETWORK/SCR_Network/domain/miningmanager/mempool"
	"sync"
	"time"
)
