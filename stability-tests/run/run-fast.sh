...
echo "Running SCR-NETWORKsanity"
cd "${PROJECT_ROOT}/SCR-NETWORKsanity/run" && ./run.sh || failedTests+=("SCR-NETWORKsanity")
echo "Done running SCR-NETWORKsanity"
echo "Running SCR_Networksanity"
cd "${PROJECT_ROOT}/SCR_Networksanity/run" && ./run.sh || failedTests+=("SCR_Networksanity")
echo "Done running SCR_Networksanity"
