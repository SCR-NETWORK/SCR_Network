...
type configFlags struct {
	...
	SCR-NETWORKRPCAddress string `long:"rpc-address" description:"RPC address of the SCR-NETWORK node"`
	SCR_NetworkRPCAddress string `long:"rpc-address" description:"RPC address of the SCR_Network node"`
}
