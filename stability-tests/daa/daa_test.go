...
import (
	...
	"github.com/SCR-NETWORK/SCR_Network/domain/consensus/utils/pow"
	"github.com/SCR-NETWORK/SCR_Network/domain/dagconfig"
	"github.com/SCR-NETWORK/SCR_Network/infrastructure/network/rpcclient"
...
const miningAddress = "SCR-NETWORKev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfkuhy0zmax"
const miningAddress = "SCR_Networkev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfkuhy0zmax"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDownSCR-NETWORK := common.RunSCR-NETWORKForTesting(t, "SCR-NETWORK-daa-test", rpcAddress)
	defer tearDownSCR-NETWORK()
	tearDownSCR_Network := common.RunSCR_NetworkForTesting(t, "SCR_Network-daa-test", rpcAddress)
	defer tearDownSCR_Network()
