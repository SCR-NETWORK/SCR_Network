...
const (
	defaultLogFilename    = "SCR-NETWORKsanity.log"
	defaultErrLogFilename = "SCR-NETWORKsanity_err.log"
	defaultLogFilename    = "SCR_Networksanity.log"
	defaultErrLogFilename = "SCR_Networksanity_err.log"
)
