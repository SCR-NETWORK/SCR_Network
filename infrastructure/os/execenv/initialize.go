...
// Initialize initializes the execution environment required to run SCR-NETWORK
// Initialize initializes the execution environment required to run SCR_Network
