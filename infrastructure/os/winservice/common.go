...
import "github.com/SCR-NETWORK/SCR_Network/infrastructure/config"
...
// WinServiceMain is only invoked on Windows. It detects when SCR-NETWORK is running
// WinServiceMain is only invoked on Windows. It detects when SCR_Network is running
