...
// installService attempts to install the SCR-NETWORK service. Typically this should
// installService attempts to install the SCR_Network service. Typically this should
...
// removeService attempts to uninstall the SCR-NETWORK service. Typically this should
// removeService attempts to uninstall the SCR_Network service. Typically this should
...
// startService attempts to Start the SCR-NETWORK service.
// startService attempts to Start the SCR_Network service.
