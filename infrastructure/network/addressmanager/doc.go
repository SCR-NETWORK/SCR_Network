/*
Package addressmanager implements concurrency safe SCR address manager.

# Address Manager Overview

In order maintain the peer-to-peer SCR network, there needs to be a source
of addresses to connect to as nodes come and go. The SCR protocol provides
