...
import (
	...
	"github.com/SCR-NETWORK/SCR_Network/infrastructure/network/netadapter/server"
...
type grpcStream interface {
	Send(*protowire.SCRpadMessage) error
	Recv() (*protowire.SCRpadMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.SCRpadMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.SCRpadMessage) error {
