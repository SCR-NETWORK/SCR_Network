...
type GetBlockTemplateRequestMessage struct {
	...
	// Which SCR address should the coinbase block reward transaction pay into
	// Which SCR address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether SCR-NETWORK thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when SCR-NETWORK is not synced.
	// That is because when SCR-NETWORK isn't in sync with the rest of the network there's a high
	// Whether SCR_Network thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when SCR_Network is not synced.
	// That is because when SCR_Network isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this SCR-NETWORK initiated the connection
	// Whether this SCR_Network initiated the connection
	...
	// The timestamp of when this peer connected to this SCR-NETWORK
	// The timestamp of when this peer connected to this SCR_Network
