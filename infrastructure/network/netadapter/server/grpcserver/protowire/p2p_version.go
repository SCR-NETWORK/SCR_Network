...
func (x *SCRpadMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SCRpadMessage_Version is nil")
	}
...
func (x *SCRpadMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
