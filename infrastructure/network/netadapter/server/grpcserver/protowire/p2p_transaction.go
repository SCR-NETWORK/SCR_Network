...
func (x *SCRpadMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SCRpadMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *SCRpadMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
