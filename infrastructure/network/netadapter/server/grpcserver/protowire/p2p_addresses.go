...
func (x *SCRpadMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "SCRpadMessage_Addresses is nil")
	}
...
func (x *SCRpadMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
