...
func (x *SCRpadMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "SCRpadMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *SCRpadMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
