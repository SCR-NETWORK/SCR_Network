...
type P2P_MessageStreamClient interface {
	Send(*SCRpadMessage) error
	Recv() (*SCRpadMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *SCRpadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*SCRpadMessage, error) {
	m := new(SCRpadMessage)
...
func (x *p2PMessageStreamServer) Send(m *SCRpadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*SCRpadMessage, error) {
	m := new(SCRpadMessage)
...
func (x *rPCMessageStreamClient) Send(m *SCRpadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*SCRpadMessage, error) {
	m := new(SCRpadMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *SCRpadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*SCRpadMessage, error) {
	m := new(SCRpadMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
