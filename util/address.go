...
import (
	"github.com/SCR-NETWORK/SCR_Network/util/bech32"
...
const (
	...
	Bech32PrefixSCR-NETWORKev
	Bech32PrefixSCR_Networkev
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"SCR":     Bech32PrefixSCR,
	"SCR-NETWORKev":  Bech32PrefixSCR-NETWORKev,
	"SCRtest": Bech32PrefixSCRTest,
	"SCRsim":  Bech32PrefixSCRSim,
	"SCR":     Bech32PrefixSCR,
	"SCR_Networkev":  Bech32PrefixSCR_Networkev,
	"SCRtest": Bech32PrefixSCRTest,
	"SCRsim":  Bech32PrefixSCRSim,
}
...
// and a payload which encodes the SCR network and address type. It is used
// and a payload which encodes the SCR network and address type. It is used
