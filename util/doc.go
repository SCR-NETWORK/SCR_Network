...
A Block defines a SCR block that provides easier and more efficient
Package util provides SCR-specific convenience functions and types.
...
A Tx defines a SCR transaction that provides more efficient manipulation of
A Tx defines a SCR transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a SCR address. While the
most common type is a pay-to-pubkey, SCR already supports others and
The Address interface provides an abstraction for a SCR address. While the
most common type is a pay-to-pubkey, SCR already supports others and
...
To decode/encode an address:
	...
	addrString := "SCR:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
	addrString := "SCR:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
	defaultPrefix := util.Bech32PrefixSCR
