...
<<<<<<< HEAD
var DefaultUserAgent = fmt.Sprintf("/SCR-NETWORK:%s/", version.Version())

// MsgVersion implements the Message interface and represents a SCR version
=======
var DefaultUserAgent = fmt.Sprintf("/SCR_Network:%s/", version.Version())
...
<<<<<<< HEAD
// NewMsgVersion returns a new SCR version message that conforms to the
=======
// NewMsgVersion returns a new SCR version message that conforms to the
>>>>>>> 0e8ed786da4e31df71edebffb326da64b0a6c3b4
