...
import (
	...
	"github.com/SCR-NETWORK/SCR_Network/cmd/SCRwallet/libSCRwallet/bip32"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"SCRwallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"SCRwallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libSCRwallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
